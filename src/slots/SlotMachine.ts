...
export class SlotMachine {
    ...
    constructor(app: PIXI.Application) {
        ...
        // Center the slot machine on the screen
    ...
    // Starts spinning all reels and disables the spin button
    public spin(): void {
        ...
        // Start each reel with a slight delay for a staggered effect
        this.reels.forEach((reel, i) => {
            setTimeout(() => reel.startSpin(), i * 150);
        });
    ...
    // Stops each reel with a delay and waits for all reels to fully stop before checking for a win
